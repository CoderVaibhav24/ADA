...
export const hi: AppResources = {
  ...
  changeDetection: {
    ...
    layers: {
      ...
      parcels: "भूखंड परिवर्तन",
      parcelCount: "{{n}} भूखंड मापे गए",
    },

    parcels: {
      title: "भूखंड परिवर्तन",
      titleWithCount: "भूखंड परिवर्तन ({{n}})",
      loading: "भूखंड लोड हो रहे हैं…",
      errorTitle: "भूखंड लोड नहीं हो सके",
      errorBody: "सर्वर ने इस संचालन के भूखंड मापन का अनुरोध अस्वीकार कर दिया।",
      retry: "फिर प्रयास करें",
      total: "भूखंड",
      assessable: "आकलन योग्य",
      bias: "उड़ान अंतर",
      biasHint:
        "आकलन योग्य भूखंडों में निर्मित क्षेत्र के परिवर्तन की माध्यिका। दोनों उड़ानों के बीच पूरे दृश्य के खिसकाव को हटाने के लिए, वर्गीकरण से पहले इसे हर भूखंड से घटाया जाता है।",
      area: "{{value}} वर्ग मी.",
      notRecorded: "दर्ज नहीं",
      histogramTitle: "निर्मित क्षेत्र में परिवर्तन (वर्ग मी.)",
      histogramLabel: "{{n}} आकलन योग्य भूखंडों में निर्मित क्षेत्र के परिवर्तन का आयतचित्र",
      histogramBin: "{{from}} से {{to}} वर्ग मी.: {{count}} भूखंड",
      histogramUncorrected: "असंशोधित: उड़ान अंतर दर्ज नहीं है, इसलिए स्तंभ शून्य पर बाँटे गए हैं।",
      histogramPivot: "लाल स्तंभ उड़ान अंतर से ऊपर हैं, नीले उससे नीचे।",
      partial:
        "आंशिक परिणाम: {{total}} में से {{loaded}} भूखंड लोड हुए। CSV में सभी भूखंड हैं।",
      filterLabel: "परिवर्तन वर्ग के अनुसार भूखंड छाँटें",
      all: "सभी",
      filterCount: "{{label}}: {{n}}",
      showing: "{{total}} में से {{shown}} दिखाए गए",
      noResultsTitle: "इस वर्ग में कोई भूखंड नहीं",
      noResultsBody: "कोई दूसरा वर्ग चुनें, या सभी भूखंड दिखाएँ।",
      showAll: "सभी भूखंड दिखाएँ",
      csv: "CSV डाउनलोड करें",
      csvRunning: "डाउनलोड हो रहा है…",
      csvFailed: "भूखंड CSV डाउनलोड नहीं हो सकी।",
      tableLabel: "इस तुलना में मापे गए भूखंड",
      sortBy: "{{column}} के अनुसार क्रमबद्ध करें",
      locate: "भूखंड {{parcel}} मानचित्र पर दिखाएँ",
      noGeometry: "इस भूखंड की कोई ज्यामिति नहीं है।",
      column: {
        parcel: "भूखंड",
        changeClass: "परिवर्तन",
        sanctioned: "स्वीकृत",
        builtT1: "पहले निर्मित",
        builtT2: "बाद में निर्मित",
        delta: "परिवर्तन (संशोधित)",
        verdictT1: "पहले का निर्णय",
        verdictT2: "बाद का निर्णय",
        landUse: "भू-उपयोग",
        plotType: "भूखंड प्रकार",
      },
      changeClass: {
        new_build: "नया निर्माण",
        extension: "विस्तार",
        demolition: "ध्वस्तीकरण",
        unchanged: "अपरिवर्तित",
        unassessable: "आकलन योग्य नहीं",
      },
      verdict: {
        over_tolerance: "सीमा से अधिक",
        within_tolerance: "सीमा के भीतर",
        vacant: "रिक्त",
        insufficient_imagery: "अपर्याप्त चित्रावली",
        not_assessable: "आकलन योग्य नहीं",
      },
    },
