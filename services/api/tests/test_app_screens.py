...
MIGRATION = REPO / "libs/python/ada-core/ada_core/alembic/versions/0005_app_screen.py"
APP_CONTRACT = REPO / "apps/field/src/sdui/contract.json"
API_CONTRACT = SERVICES / "api/app/icms/sdui_contract.json"
RUNTIME = {"runtime": "1.0"}
...
class TestContract:
    @pytest.mark.skipif(not APP_CONTRACT.exists(), reason="apps/field/ is not in this checkout")
