...
DOCUMENTED_SHAPE = {
    ...
    f"GET {ICMS_PREFIX}/cases/CMP-2026-0001/assignees": ASSIGNEE_OPTIONS,
    f"POST {ICMS_PREFIX}/cases/CMP-2026-0001/assign": CASE_DETAIL,
    f"POST {ICMS_PREFIX}/cases/CMP-2026-0001/evidence": CASE_EVIDENCE_WRITTEN,
    f"GET {ICMS_PREFIX}/cases/CMP-2026-0006/evidence": CASE_EVIDENCE,
    # Answers bytes, so there is no JSON row to pin.
    f"GET {ICMS_PREFIX}/cases/CMP-2026-0006/evidence/2/content": None,
    ...
    f"POST {ICMS_PREFIX}/cases/CMP-2026-0001/reject": CASE_DETAIL,
    f"POST {ICMS_PREFIX}/cases/CMP-2026-0012/close": CASE_DETAIL,
    # Answers bytes, so there is no JSON row to pin.
    f"GET {ICMS_PREFIX}/evidence/1/content": None,
    f"GET {ICMS_PREFIX}/evidence/1/stamped": None,
    ...
    f"GET {ICMS_PREFIX}/geo/locate": LOCATE,
    f"GET {ICMS_PREFIX}/geo/parcel": PARCEL_AT,
    f"POST {ICMS_PREFIX}/admin/geo/import": BOUNDARY_IMPORT,
    f"GET {ICMS_PREFIX}/admin/geo/imports": BOUNDARY_IMPORT_ROW,
    f"GET {ICMS_PREFIX}/admin/policy/permissions": PERMISSION,
    f"GET {ICMS_PREFIX}/admin/policy/roles": ROLE_GRANTS,
    f"POST {ICMS_PREFIX}/admin/policy/roles": ROLE_GRANTS,
    f"GET {ICMS_PREFIX}/admin/roles": ASSIGNABLE_ROLE,
    ...
    f"GET {ICMS_PREFIX}/admin/runtime-settings": RUNTIME_SETTING,
    f"PUT {ICMS_PREFIX}/admin/runtime-settings/checkin.geofence_radius_m": RUNTIME_SETTING,
    ...
    f"GET {ICMS_PREFIX}/admin/reporting": REPORTING_ROLE,
